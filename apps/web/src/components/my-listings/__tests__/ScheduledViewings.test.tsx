...
jest.mock('@/lib/api-client', () => ({ propertiesApi: { getPropertyViewings: jest.fn() } }));
...
describe('ScheduledViewings — status grouping', () => {
  it('places a future confirmed viewing in Upcoming section', async () => {
  ...
  it('places a scheduled-but-already-ended viewing in the Past section', async () => {
  ...
  it('places a completed viewing in the Past section', async () => {
  ...
  it('places declined and cancelled viewings in Past section', async () => {
