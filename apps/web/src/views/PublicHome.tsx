            ...
            {platforms.map((platform, idx) => (
              ...
              >
                <div className="flex items-start gap-6">
                  <div className={`w-16 h-16 bg-${platform.color}-100 rounded-xl flex items-center justify-center flex-shrink-0`}>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8">
                <Card className="bg-white p-6 mb-4 shadow-lg">
                  ...
                  <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                    <div className="h-full bg-gradient-to-r from-blue-600 to-green-600 w-3/4"></div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                ...
                <li>
                  <Link to="/app/contractor" className="hover:text-white transition-colors">
