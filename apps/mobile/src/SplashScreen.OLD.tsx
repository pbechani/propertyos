...
import { View, Text, TouchableOpacity, TextInput, Image, ScrollView, StyleSheet } from 'react-native';import { MotiView, MotiText, MotiScrollView } from 'moti';
      ...
      >
        <div className="mb-12">
          <div className="inline-flex items-center justify-center bg-surface-container-lowest/80 backdrop-blur-xl p-6 rounded-xl shadow-lg mb-8">
            <FontAwesome5 name="drafting-compass" className="w-12 h-12 text-primary"  />
          </div>
        ...
        <div className="flex flex-col gap-4 w-full max-w-xs">
          <Button fullWidth onPress={() => onNext('onboarding1')}>
            Start Your Project
          </Button>
          <Button variant="secondary" fullWidth onPress={() => onNext('login')}>
            Find a Contractor
          </Button>
        </div>
